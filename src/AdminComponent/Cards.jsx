...
function Cards({ show ,val ,cart, setCart, data, image, edit=false}) {
  ...
  return (
    <div class="relative m-10 flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
          ...
          <div class="mt-4 px-5 pb-5">
            <a href="#">
              <h5 class="text-xl tracking-tight text-slate-900">{show} Card Price</h5>
            </a>
            <div class="mt-2 mb-5 flex items-center justify-center">
              {
                ...
                <p>
                <CurrencyRupeeIcon/>    
                <span class="text-2xl font-bold text-slate-900">{val}</span>
                </p>
                )
              }
