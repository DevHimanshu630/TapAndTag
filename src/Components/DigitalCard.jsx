                ...
                <div className='flex flex-col gap-4 '>
                    ...
                    {showPara3 ? (
                        <div
                            ...
                            className='border p-4 text-white leading-none flex justify-center items-center pt-8 w-[262px] h-[140px] text-center rounded-xl text-[24px]'>
                ...
                <div className='flex flex-col    gap-4'>
                    {showPara2 ? (
                        <div
                            ...
                            style={radialGradient}
                            className='borde text-white flex  items-center justify-center leading-none p-8 w-[262px] h-[140px] text-center rounded-xl text-[24px]'>
                    ...
                    {showPara4 ? (
                        <div
                            ...
                            style={styleborder}
                            className='border p-5 pt-8 w-[262px] h-[140px] leading-none text-center rounded-xl text-[24px]'>
