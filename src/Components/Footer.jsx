        ...
        <footer class="bg-[#FAF9F6]  mt-24">
            <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                ...
                <div class="sm:flex sm:items-center sm:justify-between">
                    <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <Link to={""} class="hover:underline">Tap&Tag™</Link>. All Rights Reserved.
                    </span>
                    <div class="flex mt-4 sm:justify-center sm:mt-0">
                        ...
                        <Link to={""} class="text-gray-500 hover:text-gray-900 ms-5">
