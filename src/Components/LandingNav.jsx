    ...
    >
      <nav class="p-5 md:p-4 ">
        ...
        >
          ...
          <div className=" w-fit gap-3 lg:hidden p-6 flex items-center ">
            <button
              onClick={toggleMenu}
              type="button"
              className="inline-flex items-center justify-center text-sm text-white rounded-lg  -mt-[10vw] "
      ...
      >
        <div className="flex flex-col items-center z-[9999]">
          <ul class="flex flex-col w-full font-medium  -mt-[11vw] bg-[#000000c2]   ">
            <li className="border">
              <Link
                to={"/"}
                class="flex items-center justify-between py-3 text-lg  px-3 text-white  rounded "
                aria-current="page"
              >
                Home
              </Link>
