...
function ScanCart({ img, menuheading, menusubheading, menusubheading1 }) {
    ...
    return (
        <div className=' max-w-screen-xl p-3 xl:mt-32 mt-12 flex flex-wrap justify-evenly mx-auto'>
            ...
            <div className=' items-center  flex flex-col  text-center md:text-start justify-center gap-8 xl:w-[47%]'>
                <div>
                ...
                <div className='text-[18px] font-[inter] px-12 text-center font-thin  leading-normal text-[#717171] '>
                    {menusubheading}
                </div>
                <div>
