    ...
    return (
        <div class="flex min-h-full flex-col justify-center px-6 py-24 lg:px-8">
            ...
            <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                <form onSubmit={handleSubmitLogin} class="space-y-6" action="#" method="POST">
                    <div>
                        <label for="email" class="block text-sm  font-sans  font-light leading-6 text-gray-900">Email address</label>
                        <div class="mt-2">
                    ...
                    <div>
                        <div class="flex items-center justify-between">
                            ...
                            <div class="text-sm">
                                <Link to={"/accounts/password/forgot"} class="font-normal font-sans text-indigo-600 hover:text-indigo-500">Forgot password?</Link>
                            </div>
                        </div>
                        <div class="mt-2">
                    ...
                    <div>
                        <button type="submit" class="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-normal font-sans leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Sign in</button>
                    </div>
                </form>
